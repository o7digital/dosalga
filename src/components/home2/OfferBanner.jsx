        ...
        <div className="row gy-4">
          <div className="col-lg-6">
            <div className="offer-banner-left hover-img">
              <img src="https://beautico-nextjs.vercel.app/assets/img/home2/offer-banner-left-img1.png" alt="" />
          ...
          <div className="col-lg-6">
            <div className="offer-banner-right hover-img">
              <img src="https://beautico-nextjs.vercel.app/assets/img/home2/offer-banner-right-img1.png" alt="" />
