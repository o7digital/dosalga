  ...
  return (
    <header ref={headerRef} className={`header-area ${state.scrollY > 10 ?"sticky":""}`}>
        ...
        <div className={`main-menu ${state.isSidebarOpen ? "show-menu" : ""}`}>
            ...
            <li><Link legacyBehavior href="/face"><a>Face</a></Link></li>
            <li><Link legacyBehavior href="/body"><a>Body</a></Link></li>
            <li><Link legacyBehavior href="/hair"><a>Hair</a></Link></li>
            <li><Link legacyBehavior href="/makeup"><a>Makeup</a></Link></li>
            <li><Link legacyBehavior href="/about-us"><a>About Dosalga</a></Link></li>
