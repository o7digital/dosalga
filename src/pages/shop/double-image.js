                ...
                <div className={`col${activeColumn === 'column-4'?"-lg-3":activeColumn==="column-3"?"-md-4":activeColumn==="column-2"?"-sm-6":"nop"}`}>
                  <div className="product-card style-3 hover-btn">
                    <div className="product-card-img double-img">
                      <Link legacyBehavior href="/shop/product-default">
                        <a>
                        <img src="https://beautico-nextjs.vercel.app/assets/img/home1/product-img-16.png" alt="" className="img2" />
                ...
                <div className={`col${activeColumn === 'column-4'?"-lg-3":activeColumn==="column-3"?"-md-4":activeColumn==="column-2"?"-sm-6":"nop"}`}>
                  <div className="product-card style-3 hover-btn">
                    <div className="product-card-img double-img">
                      <Link legacyBehavior href="/shop/product-default">
                      <a>
                        <img src="https://beautico-nextjs.vercel.app/assets/img/home1/product-img-5.png" alt="" className="img2" />
                ...
                <div className={`col${activeColumn === 'column-4'?"-lg-3":activeColumn==="column-3"?"-md-4":activeColumn==="column-2"?"-sm-6":"nop"}`}>
                  <div className="product-card style-3 hover-btn">
                    <div className="product-card-img double-img">
                      <Link legacyBehavior href="/shop/product-default">
                      <a>
                        <img src="https://beautico-nextjs.vercel.app/assets/img/home1/product-img-9.png" alt="" className="img2" />
                        <img src="https://beautico-nextjs.vercel.app/assets/img/home1/product-img-21.png" alt="" className="img1" />
                        <div className="batch">
                          <span className="new">New</span>
                        </div>
                      </a>
                ...
                <div className={`col${activeColumn === 'column-4'?"-lg-3":activeColumn==="column-3"?"-md-4":activeColumn==="column-2"?"-sm-6":"nop"}`}>
                  <div className="product-card style-3 hover-btn">
                    <div className="product-card-img double-img">
                      <Link legacyBehavior href="/shop/product-default">
                      <a>
                        <img src="https://beautico-nextjs.vercel.app/assets/img/home1/product-img-11.png" alt="" className="img2" />
                        <img src="https://beautico-nextjs.vercel.app/assets/img/home1/product-img-14.png" alt="" className="img1" />
                        <div className="batch">
                          <span>-18%</span>
                        </div>
                      </a>
                ...
                <div className={`col${activeColumn === 'column-4'?"-lg-3":activeColumn==="column-3"?"-md-4":activeColumn==="column-2"?"-sm-6":"nop"}`}>
                  <div className="product-card style-3 hover-btn">
                    <div className="product-card-img double-img">
                      <Link legacyBehavior href="/shop/product-default">
                      <a>
                        <img src="https://beautico-nextjs.vercel.app/assets/img/home1/product-img-15.png" alt="" className="img2" />
                        <img src="https://beautico-nextjs.vercel.app/assets/img/home1/product-img-18.png" alt="" className="img1" />
                        <div className="batch">
                          <span className="new">New</span>
                        </div>
                      </a>
                ...
                <div className={`col${activeColumn === 'column-4'?"-lg-3":activeColumn==="column-3"?"-md-4":activeColumn==="column-2"?"-sm-6":"nop"}`}>
                  <div className="product-card style-3 hover-btn">
                    <div className="product-card-img double-img">
                      ...
                      <a>
                        <img src="https://beautico-nextjs.vercel.app/assets/img/home1/product-img-16.png" alt="" className="img2" />
                        <img src="https://beautico-nextjs.vercel.app/assets/img/home1/product-img-20.png" alt="" className="img1" />
                        <div className="batch">
                          <span>-15%</span>
                        </div>
                      </a>
